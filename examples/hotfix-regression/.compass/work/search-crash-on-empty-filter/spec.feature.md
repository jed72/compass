...
> **Terrain:** brownfield-mapped — on Hotfix the spec begins as the failing regression test; this file is its promoted, readable form (backfill BF-001).
...
(`evidence/red.json`) — that *was* Specify. At Land, backfill BF-001 promoted
