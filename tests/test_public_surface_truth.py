...
def test_d2_repairs_change_only_retired_names():
    ...
    A sanctioned restructure re-baselines its fingerprint in the same
    commit. The other 51 files in the fixture are untouched, and a new
    structural change to any of the 59 still fails.
    """
    import json
    snap = json.loads(
