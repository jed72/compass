"""Every published version surface reports `1.4.0`.
...
`COMPASS_VERSION` constant. This test asserts every surface reports `1.4.0`
...
OLD_VERSIONS = {"1.3.0", "1.2.0", "1.1.0", "1.0.0", "1.0.0-rc.1"}
...
def test_published_surface_reports_new_version(label, reader):
    """Every published surface reports 1.4.0 — no partial bumps."""
    actual = reader()
