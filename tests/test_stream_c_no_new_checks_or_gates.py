...
# The baseline check names that ship in guardrails.yml on main.
# Stream C must not add to this list in the checks: block.
BASELINE_CHECKS = {
...
# The baseline gate names in gate_evidence_requirements on main.
BASELINE_GATES = {
    "verify.correctness",
    "verify.regression",
    "verify.security",
