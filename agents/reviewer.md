...
Read `route.md` for the dimension set, then read the change, the evidence the
verifier gathered, `spec.feature.md`, `plan.md`, the `governance/` files
(`guardrails.md`, `strategies.md`, `routing-policy.md`), and any
`brief.md` / `positioning.md`. Apply each dimension the route includes:
